...
\SV
   ...
   function logic [31:0] rotword (input [31:0] inp);
      reg [31:0] a,b;
      reg [7:0] c;
      begin
         c = inp[31:24];
   ...
   function logic [31:0] g (input [31:0] inp, input [3:0] rno);
      reg [7:0] rcon = 8'h2;
      reg [7:0] x ;
      reg [31:0] y;
      begin
     ...
     g = y^(sboxvalue(rotword(inp)));
   endfunction
   function logic [31:0] keyexp (input [127:0] in2, input [3:0] rno);
      reg [31:0] w1, w2, w3, w4;
      begin
         w1 = in2[31:0] ^ g(in2[127:96],rno);
         w2 = in2[63:32] ^ w1;
         w3 = in2[95:64] ^ w2;
         w4 = in2[127:96] ^ w3;
      end
   ...
   |encrypt
      ...
      ?$valid
         @1
            ...
            $key1[127:0] = 128'h12345678;
            $key2[127:0] = keyexp($key1,4'b0001);
            $key3[127:0] = keyexp($key2,4'b0010);
            $key4[127:0] = keyexp($key3,4'b0011);
            $key5[127:0] = keyexp($key4,4'b0100);
            $key6[127:0] = keyexp($key5,4'b0101);
            $key7[127:0] = keyexp($key6,4'b0110);
            $key8[127:0] = keyexp($key7,4'b0111);
            $key9[127:0] = keyexp($key8,4'b1000);
            $key10[127:0] = keyexp($key9,4'b1001);
            $key11[127:0] = keyexp($key10,4'b1010);
         @2
            $block_round1[127:0] = addroundkey($block_rec, $key1);
            ...
            $block_round10[127:0] = round($block_round9, $key10);
            $block_encrypt[127:0] = round($block_round10, $key11);
